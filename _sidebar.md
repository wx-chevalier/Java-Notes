- [1 01~语法基础 [9]](/01~语法基础/README.md)
  ...
  - [1.2 02~背景与特性 [3]](/01~语法基础/02~背景与特性/README.md)
    ...
    - [1.2.3 版本特性 [9]](/01~语法基础/02~背景与特性/版本特性/README.md)
      ...
      - 1.2.3.7 Java 21 [1]
        - 1.2.3.7.1 99~参考资料 [1]
          - [1.2.3.7.1.1 2023_Java 21： The Nice, The Meh, and the ... Momentous](/01~语法基础/02~背景与特性/版本特性/Java%2021/99~参考资料/2023_Java%2021：%20The%20Nice,%20The%20Meh,%20and%20the%20...%20Momentous.md)
      - 1.2.3.8 Java 8 [1]
...
- 3 03~工程实践 [7]
  ...
  - 3.4 第三方库 [4]
    ...
    - [3.4.4 Lombok [3]](/03~工程实践/第三方库/Lombok/README.md)
  ...
  - 3.7 网络编程 [4]
    ...
    - 3.7.4 文件传输 [1]
      - 3.7.4.1 99~参考资料 [1]
        - [3.7.4.1.1 2023_Java 实现断点下载](/03~工程实践/网络编程/文件传输/99~参考资料/2023_Java%20实现断点下载.md)
  ...
  - [4.2 01~线程与线程池 [7]](/04~并发编程/01~线程与线程池/README.md)
    ...
    - [4.2.3 03.Executors [2]](/04~并发编程/01~线程与线程池/03.Executors/README.md)
      - [4.2.3.1 ExecutorService [4]](/04~并发编程/01~线程与线程池/03.Executors/ExecutorService/README.md)
        ...
        - [4.2.3.1.2 ThreadPoolExecutor](/04~并发编程/01~线程与线程池/03.Executors/ExecutorService/ThreadPoolExecutor.md)
  ...
  - [4.3 02~线程安全 [4]](/04~并发编程/02~线程安全/README.md)
    ...
    - [4.3.4 锁 [7]](/04~并发编程/02~线程安全/锁/README.md)
      ...
      - [4.3.4.5 synchronized [3]](/04~并发编程/02~线程安全/锁/synchronized/README.md)
        - 4.3.4.5.1 99~参考资料 [1]
          - [4.3.4.5.1.1 2018\_死磕 Synchronized 底层实现](/04~并发编程/02~线程安全/锁/synchronized/99~参考资料/2018_死磕%20Synchronized%20底层实现.md)
      ...
      - [4.3.4.7 锁优化 [4]](/04~并发编程/02~线程安全/锁/锁优化/README.md)
        ...
        - [4.3.4.7.2 02.锁粒度的优化](/04~并发编程/02~线程安全/锁/锁优化/02.锁粒度的优化.md)
  ...
  - 6.8 99~参考资料 [3]
    - [6.8.1 深入理解 Java 虚拟机 [4]](/06~JVM%20与性能优化/99~参考资料/2016-深入理解%20Java%20虚拟机.md/README.md)
      ...
      - 6.8.1.2 02.Java 虚拟机程序执行 [6]
        ...
        - [6.8.1.2.3 02.虚拟机字节码执行引擎\_00 虚拟机栈栈帧结构](/06~JVM%20与性能优化/99~参考资料/2016-深入理解%20Java%20虚拟机.md/02.Java%20虚拟机程序执行/02.虚拟机字节码执行引擎_00-虚拟机栈栈帧结构.md)
        - [6.8.1.2.4 02.虚拟机字节码执行引擎\_01 方法调用](/06~JVM%20与性能优化/99~参考资料/2016-深入理解%20Java%20虚拟机.md/02.Java%20虚拟机程序执行/02.虚拟机字节码执行引擎_01-方法调用.md)
        - [6.8.1.2.5 02.虚拟机字节码执行引擎\_02 基于栈的字节码解释执行引擎](/06~JVM%20与性能优化/99~参考资料/2016-深入理解%20Java%20虚拟机.md/02.Java%20虚拟机程序执行/02.虚拟机字节码执行引擎_02-基于栈的字节码解释执行引擎.md)
