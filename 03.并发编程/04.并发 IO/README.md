...
对于网络 IO 相关的基础知识可以参考 [Linux 网络 IO](https://ng-tech.icu/books/DistributedSystem-Notes/#/?q=Linux网络IO) 以及[并发 IO](https://ng-tech.icu/books/DistributedSystem-Notes/#/?q=并发IO) 的相关章节。
